...
INPUT_PORTS_START(nabu_hle_keyboard)
	...
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_UNUSED) // "Alt Mode"
	...
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED ) PORT_PLAYER(2)
	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNUSED ) PORT_PLAYER(2)
INPUT_PORTS_END
